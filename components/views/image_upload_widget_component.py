...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_icon = page.get_by_test_id(f'{identifier}-image-upload-widget-info-title-text')
        self.image_upload_info_title = page.get_by_test_id(f'{identifier}-image-upload-widget-info-title-text')
        self.image_upload_info_desciption = page.get_by_test_id(f'{identifier}-image-upload-widget-info-description-text')
    ...
    def check_visible(self, is_image_uploaded: bool = False):
        ...
        expect(self.image_upload_info_desciption).to_be_visible()
        expect(self.image_upload_info_desciption).to_have_text('Recommended file size 540X300')
